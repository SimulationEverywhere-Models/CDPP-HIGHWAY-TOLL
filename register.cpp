...
#include "aceptador.h"    // class Aceptador
#include "retardador.h"
...
void MainSimulator::registerNewAtomics()
{
	...
	SingleModelAdm::Instance().registerAtomic( NewAtomicFunction<Aceptador>() , "Aceptador" ) ;
	SingleModelAdm::Instance().registerAtomic( NewAtomicFunction<Retardador>() , "Retardador" ) ;
	SingleModelAdm::Instance().registerAtomic( NewAtomicFunction<Despachador>() , "Despachador" ) ;
	SingleModelAdm::Instance().registerAtomic( NewAtomicFunction<Interseccion>() , "Interseccion" ) ;
}
