...
EXAMPLESOBJS=interseccion.o despachador.o retardador.o cola.o mytools.o aceptador.o queue.o main.o generat.o cpu.o transduc.o trafico.o distri.o com.o linpack.o debug.o register.o
LIBNAME=simu
LIBS=-lsimu
...
clean:
	- rm -f interseccion.o despachador.o retardador.o register.o cola.o simu core drawlog initest exptest parser makerand toMap
...
despachador.o: despachador.cpp
	${CPP} -c ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $<

retardador.o: retardador.cpp
	${CPP} -c ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $<

aceptador.o: aceptador.cpp
	${CPP} -c ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $<
...
despachador.o: queue.h atomic.h model.h port.h modelid.h time.h portlist.h real.h
despachador.o: undefd.h impresion.h tbool.h except.h stringp.h value.h evaldeb.h
despachador.o: cellpos.h ntupla.h procadm.h process.h message.h strutil.h
despachador.o: mainsimu.h root.h event.h ini.h loader.h ltranadm.h mytools.h
aceptador.o: queue.h atomic.h model.h port.h modelid.h time.h portlist.h real.h
aceptador.o: undefd.h impresion.h tbool.h except.h stringp.h value.h evaldeb.h
aceptador.o: cellpos.h ntupla.h procadm.h process.h message.h strutil.h
aceptador.o: mainsimu.h root.h event.h ini.h loader.h ltranadm.h mytools.h
cola.o: queue.h atomic.h model.h port.h modelid.h time.h portlist.h real.h
...
cola.o: mainsimu.h root.h event.h ini.h loader.h ltranadm.h
